...
export const sq = {
  ...
  email: 'Email',
  username: 'Përdoruesi',
  usernamePlaceholder: 'shankisti1 ose kamerieri1',
  ...
  floorHint:
    'Monitori i kamerierit — faturat mbeten derisa të shënohen “E paguar”',
  unpaidBills: 'Fatura të hapura',
  ...
  splitHint:
    'Zgjidh artikujt për një person (ndarje fature), pastaj paguaj. Ose paguaj të gjithën.',
  ...
  mergedNote: 'U shtua te porosia ekzistuese e tavolinës',
  addToTable: 'Shto te tavolina (bashkohet me faturën e hapur)',
